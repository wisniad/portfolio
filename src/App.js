            ...
            <div className="content">
                <Grid container justify="space-around" alignItems="center">
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                        <div className="">
                            <Typist cursor={{show: false}}>
                                ...
                                <div className="divContainer__centered divContainer__important">
                                    <Typist.Delay ms={150}/> <h1>Damian Wiśniewski</h1>
                                </div>
                            </Typist>
                        </div>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                        <Grid item xs={3} sm={3}>
                            <a href="https://linkedin.com/in/damian-wisniewski/"><h4><FaLinkedin/> LinkedIn</h4></a>
                        </Grid>
                        <Grid item xs={3} sm={3}>
                            <a href="https://github.com/wisniad"><h4><FaGithub/> GitHub</h4></a>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <a href="mailto:kontakt@wisniewskidamian.pl" target="_top"><h4><MdMailOutline/> kontakt@wisniewskidamian.pl</h4></a>
                        </Grid>
